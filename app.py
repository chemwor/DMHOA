...
{{
  ...
  "critical_detail_locked": {{
    "title": "Recommended next step",
    "body": "BEFORE writing anything, decide whether the user is DISPUTING or COMPLYING based on the user's description: '{issue_str}'. DISPUTE = user says the HOA is wrong about the facts (e.g., 'the shrub IS there', 'I paid on time', 'the rule doesn't apply', 'they cited the wrong thing'). COMPLY = user agrees they need to fix something, just wants help responding. UNSURE = description is neutral facts only.\n\nIF DISPUTE: write 2-4 imperative steps focused on PRESERVING the dispute and GATHERING EVIDENCE that contradicts the HOA. Examples: 'Do NOT comply or pay the fine — either action admits the violation.' / 'Gather dated photos and receipts that establish your timeline.' / 'Send a written request for clarification rather than a call or informal email.'\n\nIF COMPLY: write 2-4 imperative steps focused on EFFICIENT REMEDIATION and DOCUMENTING completion. Examples: 'Complete the required cure before the deadline on your notice.' / 'Take dated photos of the resolved issue.' / 'Submit the cure documentation in writing, not by phone.'\n\nIF UNSURE: write 2-3 steps that preserve options. Examples: 'Save the original notice with the envelope intact.' / 'Decide between disputing or complying before any communication.' / 'Don't reply informally.'\n\nDO NOT describe the paid product. Use imperative voice. This is the user's to-do list, not a sales pitch."
  }},
  "risk_if_wrong": [
...
{{
  ...
  "critical_detail_locked": {{
    "title": "Recommended next step",
    "body": "BEFORE writing anything, decide whether the user is DISPUTING or COMPLYING based on what they wrote in 'Case Description'. DISPUTE = user says the HOA is wrong about the facts (e.g., 'the shrub IS there', 'I already paid', 'the rule doesn't apply', 'they cited me incorrectly'). COMPLY = user agrees they need to fix something. UNSURE = neutral facts only.\n\nIF DISPUTE: write 2-4 imperative steps focused on PRESERVING the dispute and GATHERING EVIDENCE that contradicts the HOA's claim. Examples: 'Do NOT replace the shrub or pay the fine — either action admits the violation.' / 'Find dated photos predating [inspection date from notice] that show the shrub was there.' / 'Locate your purchase receipt and planting records to establish the timeline.' / 'Send a written request for clarification (the AI letter is the safest path) — do not call or email informally.'\n\nIF COMPLY: write 2-4 imperative steps focused on EFFICIENT REMEDIATION and DOCUMENTING completion. Examples: 'By [deadline], complete [the cure described in the notice].' / 'Take dated photos of the resolved issue.' / 'Email the photos to [contact from notice] before the deadline.'\n\nIF UNSURE: write 2-3 steps that preserve options. Examples: 'Save the original notice with the envelope intact.' / 'Decide between disputing the facts or complying before any communication with the HOA.' / 'Don't reply informally — once anything is sent in writing, your position is locked.'\n\nDO NOT describe the paid product. Use imperative voice. Pull specifics (dates, names, contact info) from the pasted notice when possible. This is the user's to-do list."
  }},
  "risk_if_wrong": [
